...
const Brands = () => {
  ...
  const [dataBrand, setDataBrand] = useState<BrandModel[]>([]);
  ...
  function editItem(id: string) {
    modals.openConfirmModal({
      title: <Title order={5}>Chỉnh sửa sản phẩm</Title>,
  ...
  const openModalEdit = () => {
    if (
      ...
      NotificationExtension.Warn(
        "Xin vui lòng chọn 1 thương hiệu để chỉnh sửa"
      );
