...
import CustomerAppointment from "../../views/RegistrationForm/CustomerAppointment";
import Appointment from "../../views/RegistrationForm/Appointment";
...

      {
        ...
        handle: {
          crumb: () => {
            ...
            model.Text = "Đặt lịch sửa chữa";
            model.Value = "/customer-appointment";
            return model;
          },
        },
      },
