export const API_ROUTE = {
  ...
  MODIFY_ATTRIBUTE4: "/TblItem/edit-attribute4",
  ...
  GET_LIST_CUSTOMER_APPOINTMENT: "TblCustomerAppointment/get-list",
  GET_DETAIL_CUSTOMER_APPOINTMENT: "TblCustomerAppointment/detail",
  CREATE_CUSTOMER_APPOINTMENT: "TblCustomerAppointment/create",
  EDIT_CUSTOMER_APPOINTMENT: "TblCustomerAppointment/edit",
  DELETE_CUSTOMER_APPOINTMENT: "TblCustomerAppointment/delete",

  //TblAppointment
  GET_LIST_APPOINTMENT: "TblAppointments/get-list",
  GET_DETAIL_APPOINTMENT: "TblAppointments/detail",
  CREATE_APPOINTMENT: "TblAppointments/create",
  EDIT_APPOINTMENT: "TblAppointments/edit",
  DELETE_APPOINTMENT: "TblAppointments/delete",

  //TblUserManagement
  GET_LIST_MANAGEMENT: "/auth/get-list",
  GET_DETAIL_MANAGEMENT: "TblAppointments/detail",
  CREATE_MANAGEMENT: "/auth/create",
  EDIT_MANAGEMENT: "/auth/edit",
  DELETE_MANAGEMENT: "/auth/delete",
  ACTIVATED_MANAGEMENT: "/Auth/actives"
};
