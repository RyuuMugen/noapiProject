...
const CreateView = ({ handleCreateStore }: CreateViewProps) => {
  ...
  const form = useForm<TblConfigWebStore>({
    ...
    validate: {
      ...
      telephone: (value) => {
        ...
        return /^\d{10}$/.test(value.trim()) ? null : "Số điện thoại không hợp lệ";
      },
...
type CreateViewProps = {
  handleCreateStore: (data: TblConfigWebStore) => void;
};
