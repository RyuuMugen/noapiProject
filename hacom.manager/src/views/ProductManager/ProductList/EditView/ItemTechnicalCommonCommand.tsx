...
import { TblItemTechnicalCommonCommand } from "../../../../model/ProductList";
...
const ItemTechnicalCommonCommand = ({
  ...
  useEffect(() => {
    if (dataItemTechnical) {
      setSelectedValues(dataItemTechnical);
    }
  }, [dataItemTechnical]);
...
type TblItemTechnicalCommonCommandProps = {
  ...
  dataItemTechnical: TblItemTechnicalCommonCommand[] | null;
};
