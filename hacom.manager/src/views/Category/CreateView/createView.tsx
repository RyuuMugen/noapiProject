...
import { formatFormData } from "../../../_base/helper/FunctionHelper";
...
const CreateView = function ({
  ...
  function GetMetaKeywords(url: string) {
    const one = url.split(" ").length;
    setMetaKeywords(`MetaKeywords ${one} ký tự,${url.length} từ :`);
  }
  //
